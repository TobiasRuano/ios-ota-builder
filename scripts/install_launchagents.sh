...
render_plist "$ROOT/launchd/com.local.ios-ota-builder.ota-token-rotation.plist.template" \
  "${PREFIX}.ota-token-rotation.plist"
...
echo "  launchctl bootstrap gui/\$(id -u) $DEST/${PREFIX}.ota-token-rotation.plist"
